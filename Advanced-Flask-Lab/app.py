...
def home():
    return render_template('index.html', user_bio="hello I'm Maria " , image_link="https://1fid.com/wp-content/uploads/2022/06/Twitter-profile-picture-4-1024x1024.jpg" ,post=posts )
